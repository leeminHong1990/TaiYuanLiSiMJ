...
var impGameOperation = impCommunicate.extend({
	...
	startGame : function(dealerIdx, tileList, wreathsList, kingTiles, prevailing_wind, playerWindList, diceList, swap_list, standTileList){
		cc.log("startGame")
		cc.log(dealerIdx, tileList, wreathsList, kingTiles, prevailing_wind, playerWindList, diceList, swap_list, standTileList);
		var self = this;
		if(!this.curGameRoom){
			return;
		}
	...
	postOperation : function(serverSitNum, aid, tileList, buckle, standTileList){
		...
		if(aid == const_val.OP_PASS){
			...
			if(this.serverSitNum == serverSitNum){
				...
				var numStand =  cutil.get_count(standTileList, tileList[0]);
			...
			if(this.serverSitNum == serverSitNum){
                ...
                var standTileList = this.curGameRoom.standTileList[serverSitNum];
                var numStand =  cutil.get_count(standTileList, tileList[3]);
